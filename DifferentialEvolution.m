function [bestsol,bestfitness,BestFitIter,P,f] = DifferentialEvolution(prob,lb,ub,Np,T,Pc,F)
...
P = zeros(Np,D);   % Generation of the initial population
for j=1:D
    P(:,j)=P(:,j)+randi([lb(j),ub(j)],Np,1);
end
